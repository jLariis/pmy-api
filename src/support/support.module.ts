...
@Module({
  imports: [
    TypeOrmModule.forFeature([SupportTicket, SupportTicketComment, SupportTicketAttachment, SupportTicketCommentAttachment, SupportZoneAuthorizer, Subsidiary, User]),
    NotificationsModule,
    AiModule,
  ],
