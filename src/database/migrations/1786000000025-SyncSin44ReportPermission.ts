...
/**
 * Sincroniza el catálogo de permisos contra la BD para dar de alta el reporte
 * nuevo `reportes.sin44` y asignarlo a sus roles por defecto. Misma lógica
 * idempotente de SyncNewReportPermissions: solo inserta lo que falta.
 */
export class SyncSin44ReportPermission1786000000025 implements MigrationInterface {
  name = 'SyncSin44ReportPermission1786000000025';
